...
\hypersetup{
  ...
  pdfauthor={Andrea Gonzalez Natera},
  hidelinks,
...
\begin{quote}
Answer: I took John's Advance GIS class last semester which covered a
bit of Git and Python. My experience using R conisist of Betsy's Stats
class.
\end{quote}
...
\begin{quote}
Answer: I feel comfortable with the material covered by my stats class
such as GLM and ANOVAs.
\end{quote}
...
\begin{quote}
Answer: Not so much a component just the workload and time management in
general.
\end{quote}
...
\begin{quote}
Answer:
\url{https://github.com/ag522/Environmental_Data_Analytics_2021.git}
\end{quote}
