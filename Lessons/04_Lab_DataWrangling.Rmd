...
NTL.phys.data.Tuesday1990.1999 <- filter(NTL.phys.data, lakename == "Tuesday Lake", year4 %in% c(1990:1999))
...
NTL.phys.data.Ex4 <- NTL.phys.data.Ex3 %>%
  filter(depth==0) %>%
  summarise(meanSurfTemp = mean(temperature_C) )
...
NTL.phys.data.Ex5 <- pivot_longer()
